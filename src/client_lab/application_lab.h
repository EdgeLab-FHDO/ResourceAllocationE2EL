#ifndef APPLICATION_LAB_H
#define APPLICATION_LAB_H
...
extern Rect rectangle_recieved;
extern mutex rectangle_recieved_mutex;
...
class Application
{
	...
	public:
		...
		void initialize(ClientTCP * connection_TCP, time_point<system_clock, milliseconds> start_time);
